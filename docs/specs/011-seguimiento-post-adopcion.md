# Spec 011 — Seguimiento Post-Adopción (HU-9.1, HU-9.2)

**Estado:** APROBADA
**Sprint:** 7 (Fase 7 del ROADMAP) · **Responsable:** Grupo N°09 · **Última actualización:** 2026-09-02

## 1. Objetivo

Permitir que quien tiene una mascota bajo su cuidado por adopción o tránsito responda, en los momentos que el sistema le pide, cómo está el animal (descripción + foto de evidencia), y que quien la entregó (adoptante publicador o refugio) pueda ver si esas actualizaciones se están cumpliendo.

## 2. Alcance

- **Incluye:** HU-9.1 (enviar seguimiento) y HU-9.2 (ver seguimientos): generación automática de los pedidos de seguimiento según la secuencia de días, pregunta aleatoria por pedido, ventana de 48 h para responder, vencimiento con notificación al publicador, listado por solicitud y detalle.
- **NO incluye:**
  - **HU-9.3** (revisar actualización de seguimiento por el refugio) — queda para una spec propia.
